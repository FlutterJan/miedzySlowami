...
import 'package:human_maturalny/pytanieJawne.dart';

class PytaniaJawneMenu extends StatelessWidget {
  const PytaniaJawneMenu({super.key});
...
Route _createRoute(Widget page) {
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.of(
                    context,
                  ).push(_createRoute(PytanieJawne(nrPytania: nrPytania)));
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            naglowek("Mitologia, Jan Parandowski"),
 ...
 pytanie(context, "23. Postawy społeczeństwa polskiego wobec zaborcy.",23),
            ...
            SizedBox(height: 10),
            naglowek("Potop, Henryk Sienkiewicz"),
            pytanie(context, "36. Postawy odwagi i tchórzostwa.",36),
            SizedBox(height: 10),
            naglowek("Zbrodnia i kara, Fiodor Dostojewski"),
            ...
            SizedBox(height: 10),
            naglowek("Wesele, Stanisław Wyspiański"),
            pytanie(context, 
            ...
            SizedBox(height: 10),
            naglowek("Chłopi, Władysław Reymont"),
            pytanie(context, "47. Obyczaj i tradycja w życiu społeczeństwa.",47),
            SizedBox(height: 10),
            naglowek("Przedwiośnie, Stefan Żeromski"),
            pytanie(context, 
            ...
            SizedBox(height: 10),
            naglowek("Rok 1984, George Orwell"),
            ...
            69),
            SizedBox(height: 10),
            naglowek("Tango, Sławomir Mrożek"),
