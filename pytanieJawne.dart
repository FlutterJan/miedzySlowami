...
class PytanieJawne extends StatefulWidget {
  int nrPytania;
  PytanieJawne({super.key, required this.nrPytania});

  @override
  State<PytanieJawne> createState() => _PytanieJawneState();
}

class _PytanieJawneState extends State<PytanieJawne> {
